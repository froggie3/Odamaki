<?php get_header(); ?>
<div class="jumbotron full-device-height" style="background-image: url('<?php header_image(); ?>')">
	<div class="jumbotron-background container container-big full-device-height align-left">
		<?php showPageInfo(); ?>
	</div>
</div>
<div id="breakPointForNav" class="container container-big separator">
	<section>
		<h2 id="whoami" class="content-title">Who am I?</h2>
		<div class="large-section-wrapper item-border grid-test whoami-inside content-rules">
			<p class="front-introduction-passage large-section-wrapper-a ">
				こんにちは。Yokkinと申します。<br>
				かねてよりいろいろな音楽が好きで、自分の好きな曲を好きなように制作しています。<br>
				手に負えぬほどの多趣味で、昨今は大好きな英語と作曲とプログラミングを中心に勉強中です。最近自作erにもなりました。<br>
				イラストは<a href="https://twitter.com/Tsurubaming_tee">つるばみ</a>さんからいただきました。<br>
			</p>
			<ul id="followmelink" class="menu large-section-wrapper-a ">
				<li>	
	...
	<section class="separator">
		...
		<div id="contact" class="large-section-wrapper item-border content-rules">
			<p>Twitter (<a href="https://twitter.com/froggie3_" target="_blank">@froggie3_</a>) のDM、またはE-mail アドレス<code>inquiry@yokkin.com</code>より直接ご連絡ください。<br>
			OpenPGP: <a href="pgp"><code>0x1AECB1F86F84EE1E</code></a></p>
		</div>
	</section>
	...
	function embedTemplateYouTube( $videoId ) {
		echo (
			'<iframe loading="lazy" width="560" height="315" src="https://www.youtube-nocookie.com/embed/' . 
			$videoId .
	...
	<section class="separator">
		...
		<div id="works" class="grid-test grid-half-1rem-gap works">
			<div class="item item-border works-item animated-when-hovered large">
			...
			<div class="item item-border works-item animated-when-hovered">
			...
			<div class="item item-border works-item animated-when-hovered large-2">
