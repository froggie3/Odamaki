<?php get_header(); ?>
<div class="jumbotron full-device-height">
...
<div id="breakPointForNav" class="container container-big separator">
	<section>
		...
		<div class="large-section-wrapper item-border grid-test whoami-inside content-rules">
			...
			<ul class="social-links" class="menu large-section-wrapper-a ">
				<li>	
	...
	<section class="separator">
		...
		<div id="works" class="grid-test grid-half-1rem-gap works">
			<div class="item item-border works-item large">
			...
			<div class="item item-border works-item">
			...
			<div class="item item-border works-item large-2">
